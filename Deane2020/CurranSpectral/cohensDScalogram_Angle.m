function cohensDScalogram_Angle(layer, rel2BFin)
...
obs1_mean3 = circ_mean(anest2);
obs1_std3 = circ_std(anest2);

obs2_mean3 = circ_mean(awake2);
obs2_std3 = circ_std(awake2);
...
CohensDFig = figure('Name','AP Cohens D','Position',[-1070 300 1065 1000]);
...
savefig(['AP Cohens D Observed ' layer ' ' num2str(rel2BFin)])
saveas(gcf, ['AP Cohens D Observed ' layer ' ' num2str(rel2BFin) '.pdf'])
