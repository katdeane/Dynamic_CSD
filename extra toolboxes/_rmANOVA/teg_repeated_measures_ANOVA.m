...
%     if p <= pCritForFurther
        %report alphaerror cumulation
%        teg_report('', labels, iPred, df1, digprec, df2, F, p, SSM, SSE, MSM, MSE, eta, eps0, p_fwe, y_red_M, fname, verbose0, bModel, X_red_M);
        %report Bonferroni-corrected Posthoc test
        teg_report_Bonferroni('', labels, iPred, df1, digprec, df2, F, p, SSM, SSE, MSM, MSE, eta, eps0, p_fwe, y_red_M, fname, verbose0, bModel, X_red_M);
